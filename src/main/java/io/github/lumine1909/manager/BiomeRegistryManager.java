...
public class BiomeRegistryManager implements BiomeManager {
    public static Map<Object, Object> references = new HashMap<>();
    @Override
    ...
    public void registerBiome(Biome biome, ResourceKey key) {
        ...
        Object ref = MRegistryMaterials_register.invoke(ORegistryMaterials_BiomeBase_,
                resKey,
                ((WrappedBiome) biome).getNmsBiome(),
                MLifeCycle_stable.invoke(null));
        references.put(((WrappedBiome) biome).getNmsBiome(), ref);
